...
/mob/living/silicon/robot/proc/pick_module()
	...
	var/mod = input("Please, select a module!", "Robot", null, null) in list("Standard", "Engineering", "Janitor", "Medical", "Miner", "Security", "Service")
	if(module)
		return
	switch(mod)
		if("Standard")
		...
		if("Service")
			...
			var/icontype = input("Select an icon!", "Robot", null, null) in list("Waitress", "Bro", "Butler", "Kent", "Butt")
