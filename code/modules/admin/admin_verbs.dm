...
//			src.verbs += /obj/admins/proc/togglegoonsay
		...
		if ("High Administrator")
			...
			if(src.holder.state == 2) //observing
				...
				src.verbs += /client/proc/jumptomob
				src.verbs += /client/proc/jumptokey
				src.verbs += /obj/admins/proc/adjump
...
/client/proc/unstealthadmin()
	set name = "# SHOW SPECIAL ADMIN COMMANDS #"
	set category = "Admin"
	src << "Enabling all your special admin commands."
	src.verbs += /client/proc/stealthadmin
...
/client/proc/stealthadmin()
	set name = "# HIDE SPECIAL ADMIN COMMANDS #"
	set category = "Admin"
	src << "Disabling your special admin commands so you can enjoy the game."
	src.verbs -= /client/proc/stealthadmin
	src.verbs += /client/proc/unstealthadmin
	switch (src.holder.rank)
		if ("Host")
