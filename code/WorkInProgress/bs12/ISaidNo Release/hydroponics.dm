...
/datum/plant/tomato
	name = "tomato"
	harvtype = "fruit"
	crop = /obj/item/we6352apon/reagent_containers/food/snacks/grown/tomato
	seed = /obj/item/seed/tomato
	starthealth = 20
	growtime = 375
	harvtime = 550
	cropsize = 2
	...
	endurance = 3
	mutable = 0
	//mutcrop1 = /obj/item/weapon/reagent_containers/food/snacks/grown/tomato/explosive
	//mutcrop2 = /obj/critter/killertomato

/datum/plant/grape
	name = "grape"
	harvtype = "fruit"
	crop = /obj/item/weapon/reagent_containers/food/snacks/grown/grape
	seed = /obj/item/seed/grape
	starthealth = 5
	growtime = 200
	harvtime = 600
	cropsize = 3
...
/datum/plant/orange
	name = "orange"
	harvtype = "fruit"
	crop = /obj/item/weapon/reagent_containers/food/snacks/grown/orange
	seed = /obj/item/seed/orange
	starthealth = 20
	growtime = 300
	harvtime = 500
	cropsize = 1
...
/datum/plant/melon
	name = "melon"
	harvtype = "fruit"
	crop = /obj/item/weapon/reagent_containers/food/snacks/grown/melon
	seed = /obj/item/seed/melon
	starthealth = 80
	growtime = 600
	harvtime = 1000
	cropsize = 1
...
/datum/plant/chili
	name = "chili"
	harvtype = "fruit"
	crop = /obj/item/weapon/reagent_containers/food/snacks/grown/chili
	seed = /obj/item/seed/chili
	starthealth = 20
	growtime = 300
	harvtime = 500
	cropsize = 2
	...
	endurance = 3
	mutable = 1
	//mutcrop1 = /obj/item/weapon/reagent_containers/food/snacks/grown/chili/chilly

/datum/plant/synthmeat
	name = "synthmeat"
	crop = /obj/item/weapon/reagent_containers/food/snacks/ingredient/meat/synthmeat
	seed = /obj/item/seed/synthmeat
	starthealth = 5
	growtime = 300
	harvtime = 600
	cropsize = 2
...
/datum/plant/apple
	name = "apple"
	harvtype = "fruit"
	crop = /obj/item/weapon/reagent_containers/food/snacks/grown/apple
	seed = /obj/item/seed/apple
	starthealth = 40
	growtime = 1000
	harvtime = 1300
	cropsize = 2
...
/datum/plant/banana
	name = "banana"
	harvtype = "fruit"
	crop = /obj/item/weapon/reagent_containers/food/snacks/grown/banana
	seed = /obj/item/seed/banana
	starthealth = 15
	growtime = 600
	harvtime = 800
	cropsize = 3
...
/datum/plant/lime
	name = "lime"
	harvtype = "fruit"
	crop = /obj/item/weapon/reagent_containers/food/snacks/grown/lime
	seed = /obj/item/seed/lime
	starthealth = 30
	growtime = 150
	harvtime = 500
	cropsize = 2
...
/datum/plant/lemon
	name = "lemon"
	harvtype = "fruit"
	crop = /obj/item/weapon/reagent_containers/food/snacks/grown/lemon
	seed = /obj/item/seed/lemon
	starthealth = 30
	growtime = 500
	harvtime = 650
	cropsize = 2
...
/datum/plant/lettuce
	name = "lettuce"
	harvtype = "fruit"
	crop = /obj/item/weapon/reagent_containers/food/snacks/grown/lettuce
	seed = /obj/item/seed/lettuce
	starthealth = 30
	growtime = 200
	harvtime = 400
	cropsize = 4
...
/datum/plant/carrot
	name = "carrot"
	harvtype = "fruit"
	crop = /obj/item/weapon/reagent_containers/food/snacks/grown/carrot
	seed = /obj/item/seed/carrot
	starthealth = 20
	growtime = 250
	harvtime = 500
	cropsize = 3
...
/datum/plant/potato
	name = "potato"
	harvtype = "fruit"
	crop = /obj/item/weapon/reagent_containers/food/snacks/grown/potato
	seed = /obj/item/seed/potato
	starthealth = 40
	growtime = 400
	harvtime = 800
	cropsize = 2
...
/datum/plant/pumpkin
	name = "pumpkin"
	harvtype = "fruit"
	crop = /obj/item/weapon/reagent_containers/food/snacks/grown/pumpkin
	seed = /obj/item/seed/pumpkin
	starthealth = 60
	growtime = 100
	harvtime = 175
	cropsize = 2
...
/datum/plant/slurrypod
	...
	growthmode = "weed"
	harvtype = "fruit"
	crop = /obj/item/weapon/reagent_containers/food/snacks/grown/slurryfruit
	seed = /obj/item/seed/slurrypod
	starthealth = 25
	growtime = 150
	harvtime = 300
	harvests = 1
	cropsize = 2
	endurance = 30
	//mutcrop1 = /obj/item/weapon/reagent_containers/food/snacks/grown/slurryfruit/omega
...
/datum/plant/plasmabloom
	...
	seed = /obj/item/seed/plasmabloom
	starthealth = 8
	growtime = 600
	harvtime = 1800
	harvestable = 0
...
/obj/machinery/plantpot
	...
	process()
		...
		if (!src.current && prob(1) && prob(4))
			switch (rand(1,6))
				if (1)
					var/obj/item/seed/fungus/WS = new(src)
					...
					del WS
				if (2)
					var/obj/item/seed/lasher/WS = new(src)
					HYPnewplant(WS)
					sleep(5)
					del WS
				if (3)
					...
					del WS
				if (4)
					var/obj/item/seed/radweed/WS = new(src)
					HYPnewplant(WS)
					sleep(5)
					del WS
				if (5)
					var/obj/item/seed/slurrypod/WS = new(src)
					var/datum/plant/stored = WS.planttype
					var/datum/plantgenes/DNA = WS.plantgenes
					if (stored.mutable && prob(3)) DNA.mutantvar = rand(1,stored.mutable)
					HYPnewplant(WS)
					...
					del WS
				if (6)
					var/obj/item/seed/grass/WS = new(src)
					HYPnewplant(WS)
					sleep(5)
					del WS
			return
...
*/
			...
			if (src.current)
				...
				return
			for(var/mob/O in viewers(user, null)) O.show_message(text("\blue [] plants a seed in the [].", user, src), 1)
			var/obj/item/seed/WS = new W:seedpath(src)
			HYPnewplant(WS)
			sleep(5)
			del WS
		...
		if (src.current)
			if (src.isready == 1)
				...
				if (getamount < 1) user << "\red You weren't able to harvest anything worth salvaging."
					...
					while (getamount > 0)
						if (dogenes == 1)
							var/obj/item/weapon/reagent_containers/food/snacks/grown/F = new getitem(user.loc)
							...
							var/obj/item/seed/S = new getseed(user.loc)
...
/obj/reagent_dispensers/compostbin
	...
	attackby(obj/item/weapon/W as obj, mob/user as mob)
		var/load = 1
		if (istype(W,/obj/item/weapon/reagent_containers/food/snacks/grown/)) src.reagents.add_reagent("poo", 20)
	...
	MouseDrop_T(atom/movable/O as mob|obj, mob/user as mob)
		if (istype(O, /obj/item/weapon/reagent_containers/food/snacks/grown/) || istype(O, /obj/item/weapon/reagent_containers/food/snacks/mushroom/) || istype(O, /obj/item/seed/) || istype(O, /obj/item/weapon/plant/))
...
/obj/submachine/chem_extractor/
	...
	var/working = 0
	var/pcount = 0
	var/list/allowed = list(/obj/item/weapon/reagent_containers/food/snacks/grown/,\
	...
	attack_hand(var/mob/user as mob)
		user.machine = src
		if (src.working)
			var/dat = {"<link rel='stylesheet' href='http://lemon.d2k5.com/ui.css' /><B>Reagent Extractor</B><BR>
			<HR><BR>
			...
			var/dat = "<link rel='stylesheet' href='http://lemon.d2k5.com/ui.css' /><B>Reagent Extractor</B><BR><HR>"
			if (src.beaker)
		...
		if(href_list["ops"])
			...
			if(operation == 1) // Begin Working
				...
				for(var/obj/item/I in src.contents)
					...
					if(istype(I,/obj/item/weapon/reagent_containers/food/snacks/grown/chili/chilly)) G.reagents.add_reagent("cryostylane", 20)
					else if(istype(I,/obj/item/weapon/reagent_containers/food/snacks/grown/chili)) G.reagents.add_reagent("capsaicin", 20)
					else if(istype(I,/obj/item/weapon/reagent_containers/food/snacks/grown/orange)) G.reagents.add_reagent("juice_orange", 20)
					else if(istype(I,/obj/item/weapon/reagent_containers/food/snacks/grown/lime)) G.reagents.add_reagent("juice_lime", 20)
					else if(istype(I,/obj/item/weapon/reagent_containers/food/snacks/grown/lemon)) G.reagents.add_reagent("juice_lemon", 20)
					else if(istype(I,/obj/item/weapon/reagent_containers/food/snacks/grown/tomato)) G.reagents.add_reagent("juice_tomato", 20)
					...
					else if(istype(I,/obj/item/weapon/reagent_containers/food/snacks/grown/slurryfruit)) G.reagents.add_reagent("toxic_slurry", 20)
					else if(istype(I,/obj/item/weapon/reagent_containers/food/snacks/grown/slurryfruit/omega))
...
/obj/submachine/seedextractor
	...
	attackby(obj/item/weapon/W as obj, mob/user as mob)
		...
		while (give > 0)
			...
			var/obj/item/seed/S = new stored.seed(src)
			sleep(2)
			var/datum/plantgenes/SDNA = S.plantgenes
		...
		for (var/obj/item/seed/SEED in src.contents) SEED.loc = src.loc
...
/obj/submachine/seedmutator
	...
	var/screen = 1
	var/current = 1
	var/obj/item/seed/seed1 = null
	var/obj/item/seed/seed2 = null
	...
	Topic(href, href_list)
		if(href_list["ops"])
			var/operation = text2num(href_list["ops"])
			var/obj/item/seed/SEED = null
			if (src.current == 1) SEED = src.seed1
			else SEED = src.seed2
			var/datum/plantgenes/DNA = SEED.plantgenes
			if(operation == 1) // Maturation Gene
				IrradiateP1()
				for(var/obj/item/seed/S in src.contents) DNA.growtime -= rand(5,10)
			if(operation == 2) // Production Gene
				IrradiateP1()
				for(var/obj/item/seed/S in src.contents) DNA.harvtime -= rand(5,10)
			if(operation == 3) // Lifespan Gene
				IrradiateP1()
				for(var/obj/item/seed/S in src.contents)
			...
			if(operation == 7) // Eject Seeds
				for(var/obj/item/seed/S in src.contents) S.loc = get_turf(src)
				src.seed1 = null
				src.seed2 = null
			...
			if(operation == 10) // Splice seeds
				var/obj/item/seed/SEED1 = src.seed1
				var/obj/item/seed/SEED2 = src.seed2
				...
				var/obj/item/seed/S = new getseed(src.loc)
				...
				src.seed1 = null
				src.seed2 = null
				for(var/obj/item/seed/D in src.contents) del D
...
/obj/submachine/seed_vendor
	...
	Topic(href, href_list)
		...
		if(href_list["vend"])
			...
			switch(ops)
				if(1) getseed = /obj/item/seed/tomato
				if(2) getseed = /obj/item/seed/grape
				if(3) getseed = /obj/item/seed/orange
				if(4) getseed = /obj/item/seed/melon
				if(5) getseed = /obj/item/seed/chili
				if(6) getseed = /obj/item/seed/apple
				if(7) getseed = /obj/item/seed/banana
				if(8) getseed = /obj/item/seed/lemon
				if(9) getseed = /obj/item/seed/lime
				if(11) getseed = /obj/item/seed/wheat
				if(12) getseed = /obj/item/seed/sugar
				if(13) getseed = /obj/item/seed/synthmeat
				if(14) getseed = /obj/item/seed/carrot
				if(15) getseed = /obj/item/seed/lettuce
				if(16) getseed = /obj/item/seed/lettuce	//Strumpetplaya - Changed this to lettuce temporarily.  Was pumpkin
				if(17) getseed = /obj/item/seed/asomna
				if(18) getseed = /obj/item/seed/nureous
				if(19) getseed = /obj/item/seed/contusine
				if(20) getseed = /obj/item/seed/commol
				if(21) getseed = /obj/item/seed/venne
				if(22) getseed = /obj/item/seed/cannabis
				if(23) getseed = /obj/item/seed/fungus
				if(24) getseed = /obj/item/seed/lasher
				if(25) getseed = /obj/item/seed/creeper
				if(26) getseed = /obj/item/seed/radweed
				if(27) getseed = /obj/item/seed/slurrypod
				if(28) getseed = /obj/item/seed/potato
				if(29) getseed = /obj/item/seed/grass
			if (!src.working)
...
/obj/machinery/vending/seeds
	...
	icon_state = "cigs"
	product_paths = "/obj/item/seed/tomato;/obj/item/seed/orange;/obj/item/seed/grape;/obj/item/seed/melon;/obj/item/seed/chili;/obj/item/seed/apple;/obj/item/seed/banana;/obj/item/seed/lemon;/obj/item/seed/lime;/obj/item/seed/carrot;/obj/item/seed/wheat;/obj/item/seed/synthmeat;/obj/item/seed/sugar;/obj/item/seed/contusine;/obj/item/seed/nureous;/obj/item/seed/asomna;/obj/item/seed/commol;/obj/item/seed/venne"
	product_amounts = "20;20;20;20;20;20;20;20;20;20;20;20;20;20;20;20;20;20;20;20"
	vend_delay = 10
	product_hidden = "/obj/item/seed/cannabis;/obj/item/seed/pumpkin"
	vend_delay = 1
...
/obj/item/weapon/seedplanter
	...
	var/seedpath = /obj/item/seed/apple

	attack_self(var/mob/user as mob)
		playsound(src.loc, 'click.ogg', 100, 1)
		var/input = input(usr, "Enter the name of the seed you want.", "Seed Fabricator", null)
		switch(input)
			if("Apple", "apple") src.seedpath = /obj/item/seed/apple
			if("Asomna", "asomna") src.seedpath = /obj/item/seed/asomna
			if("Banana", "banana") src.seedpath = /obj/item/seed/banana
			if("Lettuce", "lettuce") src.seedpath = /obj/item/seed/lettuce
			if("Carrot", "carrot") src.seedpath = /obj/item/seed/carrot
			if("Chili", "chili") src.seedpath = /obj/item/seed/chili
			if("Commol", "commol") src.seedpath = /obj/item/seed/commol
			if("Contusine", "contusine") src.seedpath = /obj/item/seed/contusine
			if("Grape", "grape") src.seedpath = /obj/item/seed/grape
			if("Lemon", "lemon") src.seedpath = /obj/item/seed/lemon
			if("Lime", "lime") src.seedpath = /obj/item/seed/lime
			if("Melon", "melon", "Watermelon", "watermelon") src.seedpath = /obj/item/seed/melon
			if("Nureous", "nureous") src.seedpath = /obj/item/seed/nureous
			if("Orange", "orange") src.seedpath = /obj/item/seed/orange
			if("Potato", "potato") src.seedpath = /obj/item/seed/potato
			//if("Pumpkin", "pumpkin") src.seedpath = /obj/item/seed/pumpkin	Strumpetplaya - commented out
			if("Sugar", "sugar", "Sugarcane", "sugarcane") src.seedpath = /obj/item/seed/sugar
			if("Synthmeat", "synthmeat", "Meat", "meat") src.seedpath = /obj/item/seed/synthmeat
			if("Tomato", "tomato") src.seedpath = /obj/item/seed/tomato
			if("Venne", "venne") src.seedpath = /obj/item/seed/venne
			if("Wheat", "wheat") src.seedpath = /obj/item/seed/wheat
			if(null) return
