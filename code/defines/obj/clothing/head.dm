...
/obj/item/clothing/head/radiation
	...
	flags = FPRINT|TABLEPASS|HEADSPACE|HEADCOVERSEYES|HEADCOVERSMOUTH|HEADCOVERSHAIR
...
/obj/item/clothing/head/nursecap
	name = "Nurse Hat"
	desc = "Smokin'"
	icon_state = "nursehat"
...
/obj/item/clothing/head/Neurostimulator
	name = "Neurostimulator"
	desc = "A tool used by medics to stabilize critically injuried.  "
	icon_state = "Neurostim"
	flags = FPRINT | TABLEPASS | HEADSPACE | HEADCOVERSHAIR
...
/obj/item/clothing/head/helmet/space/capspace
	...
	flags = FPRINT | TABLEPASS | HEADSPACE | HEADCOVERSEYES | HEADCOVERSHAIR
	see_face = 0.0
	item_state = "capspace"
	permeability_coefficient = 0.01
...
/obj/item/clothing/head/helmet/space/emergency
	name = "emergency pressure helmet"
	desc = "A disposable helmet for short-term use in low-pressure environments."
...
/obj/item/clothing/head/helmet/swat
	...
	icon_state = "swat"
	flags = FPRINT | TABLEPASS | SUITSPACE | HEADSPACE | HEADCOVERSEYES | HEADCOVERSHAIR
	item_state = "swat"
...
/obj/item/clothing/head/helmet/riot
	name = "riot helmet"
	icon_state = "riothelm"
	flags = FPRINT | TABLEPASS | HEADCOVERSEYES | HEADCOVERSHAIR
	item_state = "riothelm"
	armor = list(melee = 80, bullet = 60, laser = 50, taser = 25, bomb = 50, bio = 30, rad = 0)
...
/obj/item/clothing/head/helmet/riot
	...
	icon_state = "riot"
	item_state = "helmet"
	flags = FPRINT|TABLEPASS|SUITSPACE|HEADCOVERSEYES|HEADCOVERSHAIR
...
/obj/item/clothing/head/helmet/nernhat
	name = "Gunner's hat"
	desc = "He wants to be the very best that no one ever was."
	icon_state = "nernhat"
	flags = FPRINT|TABLEPASS|SUITSPACE
	armor = list(melee = 0, bullet = 0, laser = 2, taser = 2, bomb = 0, bio = 0, rad = 0)

/obj/item/clothing/head/helmet/douchehat
	name = "Backwards ballcap"
	desc = "What sort of a douche wears a hat backwards?"
	icon_state = "reddouchehat"
	flags = FPRINT|TABLEPASS|SUITSPACE
	armor = list(melee = 0, bullet = 0, laser = 2, taser = 2, bomb = 0, bio = 0, rad = 0)

/obj/item/clothing/head/helmet/screwballhat
	name = "Screwball's handy dandy special hat."
	desc = "nurums, it here now cab you unban me from the ai position plz."
	icon_state = "screwballhat"
	flags = FPRINT|TABLEPASS|SUITSPACE
	armor = list(melee = 80, bullet = 60, laser = 20, taser = 80, bomb = 0, bio = 0, rad = 0)
...
/obj/item/clothing/head/helmet/space/syndicate/desertpunkhelmet
	name = "Desert Punk's Helmet"
	icon_state = "desertpunkhelmet"
	item_state = "desertpunkhelmet"