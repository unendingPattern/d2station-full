...
// /obj/item/weapon/spacecash(mob/user as mob)

/obj/item/weapon/spacecash
	name = "Money"
	desc = "This is your money!"
	icon = 'items.dmi'
	icon_state = "rcd"
	opacity = 0
	density = 0
...
/obj/item/weapon/spacecash/attack_self(mob/user as mob)
	...
	if (mvalidate > src.moneyvalue)
		...
		spacecash.name = "[mvalidate] D2S (Money)"
...
/obj/item/weapon/card/id/wepaccess
	name = "Weapons Research Access"
	icon_state = "idwep"
	item_state = "idwep"
	New()
		access = get_access("wepaccess")
		..()
...
/obj/item/weapon/gun/energy/Research/Heavy_Plasma
	...
	desc = "The ultimate in urban pacification. I FUCKING LOVE THIS GUN."
	icon_state = "HPR"
	w_class = 5.0
	throw_speed = 2
	throw_range = 20
...
/obj/item/weapon/wrapping_paper
	name = "wrapping paper"
	desc = "Keep those gifts a suprise until opened!"
	icon = 'items.dmi'
