...
/obj/item/weapon/mop/afterattack(atom/A, mob/user as mob)
	...
	if (istype(A, /turf/simulated))
		...
		for(var/obj/rune/R in A)
			del(R)
		mopcount++
	else if (istype(A, /obj/decal/cleanable/blood) || istype(A, /obj/decal/cleanable/shit) || istype(A, /obj/overlay) || istype(A, /obj/decal/cleanable/xenoblood) || istype(A, /obj/rune) )
		for(var/mob/O in viewers(user, null))
