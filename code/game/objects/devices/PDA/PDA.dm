...
/obj/item/device/pda
	name = "PDA"
	desc = "A portable microcomputer by Kinesthesia Labs Systems, LTD. Functionality determined by a preprogrammed ROM cartridge."
	icon = 'pda.dmi'
	icon_state = "pda"
	...
	var/note = "Congratulations, your station has chosen the Kinesthesia Labs 5100 Personal Data Assistant!" //Current note in the notepad function.
...
/obj/item/device/pda/clown
	...
	desc = "A portable microcomputer by Kinesthesia Labs Systems, LTD. The surface is coated with polytetrafluoroethylene and banana drippings."
	ttone = "honk"
	...
	if (!src.owner)
		...
		switch (src.mode)
			if ("main")
				...
				dat += "<li><a href='byond://?src=\ref[src];jobwiki=1'><img src=pda_notes.png> Jobpedia</a></li>"
				dat += "<li><a href='byond://?src=\ref[src];locations=1'><img src=pda_scanner.png> Locations</a></li>"
			...
			if ("locations")
				dat += "<h4><img src=pda_notes.png> DonkMaps V2.0</h4>"

				dat += "<img src='http://www.somethingdickful.com/ss13resources/oldmaprem-legends.png'>"
...
//				else if (istype(src.loc, /turf)) src.id.loc = src.loc
		...
		else if (href_list["jobwiki"])
			src.mode = "jobwiki"

		else if (href_list["locations"])
			src.mode = "locations"
