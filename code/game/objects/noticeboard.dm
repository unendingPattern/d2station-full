...
/obj/mapboard/attack_hand(user as mob)
	var/dat = "<meta HTTP-EQUIV='REFRESH' content='0; url=http://www.d2k5.com/ss13resources/map.php?legends=1'>Loading map..."
	user << browse("[dat]","window=mapboard")
	onclose(user, "mapboard")

/obj/priceboard/attack_hand(user as mob)
	var/dat = "<meta HTTP-EQUIV='REFRESH' content='0; url=http://vps.d2k5.com/d2station/pricing/[items].html'>Loading..."
