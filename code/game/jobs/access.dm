...
//event
	...
	access_securityeh = 41
	access_medlabeh = 42
	access_engineeh = 43
	access_external_airlockseh = 44
	access_change_idseh = 45
	access_ai_uploadeh = 46
	access_teleportereh = 47
	access_headseh = 48
	access_captaineh = 49
	access_internal_doorseh = 50
...
/proc/get_access(job)
	switch(job)
		...
		if("Scientist")
			return list(access_tox, access_tox_storage, access_chemistry)
		if("Head of Security")
		...
		if("Captain of the Event Horizon")
			return list(access_internal_doorseh, access_securityeh, access_medlabeh, access_engineeh, access_external_airlockseh, access_change_idseh, access_ai_uploadeh, access_teleportereh, access_headseh, access_captaineh)
...
/proc/get_access_desc1(A)
	switch(A)
		if(access_internal_doorseh)
			return "Ship internal doors"
		if(access_securityeh)
			return "Security"
		if(access_medlabeh)
			return "Medical"
		if(access_securityeh)
		...
		if(access_engineeh)
			return "Engineering"
		if(access_external_airlockseh)
			return "Airlocks"
		if(access_change_idseh)
			return "ID Computer"
		if(access_ai_uploadeh)
			return "AI upload"
		if(access_teleportereh)
			return "Teleporter"
		if(access_headseh)
			return "Commander"
		if(access_captaineh)
...
/*/proc/get_access(job)
	switch(job)
		if("Captain of the Event Horizon")
			return list(access_securityeh, access_medlabeh, access_engineeh, access_external_airlockseh, access_change_idseh, access_ai_uploadeh, access_teleportereh, access_headseh, access_captaineh)


		else
			return list()
*/
/proc/get_all_accesses1()
	return list(access_internal_doorseh, access_securityeh, access_medlabeh, access_engineeh, access_external_airlockseh, access_change_idseh, access_ai_uploadeh, access_teleportereh, access_headseh, access_captaineh)


/proc/get_all_jobs1()
	return list("Captain of the Event Horizon")
